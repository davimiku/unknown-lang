...
fn int_add_param_and_constant() {
    let code = "let main = fun (i: Int) -> { i + 6 }";
...
fn int_sub_param_and_constant() {
    let code = "let main = fun (i: Int) -> { i - 10 }";
...
fn int_mul_param_and_constant() {
    let code = "let main = fun (i: Int) -> { i * 8 }";
...
fn much_int_arithmetic() {
    let code = "let main = fun (a: Int, b: Int) -> { a + 2 * b - 7 }";
...
#[test]
fn float_add_params() {
    let code = "let main = fun (a: Float, b: Float) -> { a + b }";
...
fn float_int_add_params() {
    let code = "let main = fun (a: Float, b: Int) -> { a + b }";
...
fn int_float_add_params() {
    let code = "let main = fun (a: Int, b: Float) -> { a + b }";
...
fn much_float_arithmetic() {
    let code = "let main = fun (a: Float, b: Float) -> { a + 2 * b - 7 }";
