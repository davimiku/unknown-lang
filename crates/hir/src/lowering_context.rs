...
use crate::expr::{
    ArrayLiteralExpr, FunctionExpr, FunctionParam, IfExpr, IndexIntExpr, UnaryExpr, VarRefExpr,
};
use crate::interner::{Interner, Key};
use crate::scope::ModuleScopes;
use crate::type_expr::{self, TypeExpr, TypeRefExpr, TypeSymbol};
use crate::typecheck::{self, check_expr, TypeDatabase};
use crate::{BlockExpr, Database, Expr, Type, UnaryOp, ValueSymbol};
...
impl Context {
    pub fn new(interner: Interner) -> Self {
        ...
        core_value!(keys.add, Type::func(vec![t.int, t.int], t.int));
...
impl Context {
    ...
    fn lower_let_binding(&mut self, ast: ast::LetBinding) -> Expr {
        ...
        let key = self.current_scopes_mut().insert_value(name);
    ...
    fn lower_binary(&mut self, ast: ast::Binary) -> Expr {
        ...
        Expr::call(callee, String::new(), vec![lhs, rhs])
    }
